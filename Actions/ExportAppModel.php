...
class ExportAppModel extends AbstractAction {
	...
	public function get_model_data_sheets(AppInterface $app){
		...
		$sheets[] = $this->get_object_data_sheet($app, $this->get_workbench()->model()->get_object('ExFace.Core.DATASRC'), 'APP', array('CONNECTION','CUSTOM_CONNECTION','QUERYBUILDER','CUSTOM_QUERY_BUILDER'));
